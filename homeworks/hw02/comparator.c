...
int main(){
  ...
  FILE *file;
  unsigned char buffer_small[512];
  unsigned char buffer_medium[5120];
  unsigned char buffer_large[512000];
  
  RAND_bytes(buffer_small, 512);
  ...
  printf("Wrote 1KB of random data to random_small.txt\n");
  fclose(file);
  
  RAND_bytes(buffer_medium, 5120);
  ...
  printf("Wrote 10KB of random data to random_medium.txt\n");
  fclose(file);
  
  RAND_bytes(buffer_large, 512000);
  ...
  printf("Wrote 1MB of random data to random_large.bin\n");
  fclose(file);
  ...
  cpu_usage = end - start;
  printf("Encryption of 1KB file completed in %d ms using AES-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Encryption of 10KB file completed in %d ms using AES-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Encryption of 1MB file completed in %d ms using AES-128-CBC\n", cpu_usage);
  printf("%s\n", line);
  ...
  cpu_usage = end - start;
  printf("Decryption of 1KB file completed in %d ms using AES-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Decryption of 10KB file completed in %d ms using AES-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Decryption of 1MB file completed in %d ms using AES-128-CBC\n", cpu_usage);
  printf("%s\n", line);
  
  /*encryption using ARIA CBC mode*/
  source_file = fopen("random_small.txt", "rb");
  destination_file = fopen("aria_small_enc.bin", "wb");
  ...
  cpu_usage = end - start;
  printf("Encryption of 1KB file completed in %d ms using ARIA-128-CBC\n", cpu_usage);
  
  source_file = fopen("random_medium.txt", "rb");
  destination_file = fopen("aria_medium_enc.bin", "wb");
  ...
  cpu_usage = end - start;
  printf("Encryption of 10KB file completed in %d ms using ARIA-128-CBC\n", cpu_usage);
  
  source_file = fopen("random_large.bin", "rb");
  destination_file = fopen("aria_large_enc.bin", "wb");
  ...
  cpu_usage = end - start;
  printf("Encryption of 1MB file completed in %d ms using ARIA-128-CBC\n", cpu_usage);
  printf("%s\n", line);
  
  /*decryption using ARIA CBC mode*/
  source_file = fopen("aria_small_enc.bin", "rb");
  destination_file = fopen("aria_small_dec.bin", "wb");
  ...
  cpu_usage = end - start;
  printf("Decryption of 1KB file completed in %d ms using ARIA-128-CBC\n", cpu_usage);
  
  source_file = fopen("aria_medium_enc.bin", "rb");
  destination_file = fopen("aria_medium_dec.bin", "wb");
  ...
  cpu_usage = end - start;
  printf("Decryption of 10KB file completed in %d ms using ARIA-128-CBC\n", cpu_usage);
  
  source_file = fopen("aria_large_enc.bin", "rb");
  destination_file = fopen("aria_large_dec.bin", "wb");
  ...
  cpu_usage = end - start;
  printf("Decryption of 1MB file completed in %d ms using ARIA-128-CBC\n", cpu_usage);
  printf("%s\n", line);
  ...
  cpu_usage = end - start;
  printf("Encryption of 1KB file completed in %d ms using CAMELLIA-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Encryption of 10KB file completed in %d ms using CAMELLIA-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Encryption of 1MB file completed in %d ms using CAMELLIA-128-CBC\n", cpu_usage);
  printf("%s\n", line);
  ...
  cpu_usage = end - start;
  printf("Decryption of 1KB file completed in %d ms using CAMELLIA-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Decryption of 10KB file completed in %d ms using CAMELLIA-128-CBC\n", cpu_usage);
  ...
  cpu_usage = end - start;
  printf("Decryption of 1MB file completed in %d ms using CAMELLIA-128-CBC\n", cpu_usage);
  printf("%s\n", line);
